...
public class ListaVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblVendas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cliente", "Data da Venda", "Valor da Venda"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(btnRemover, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if (tblVendas.getSelectedRow() != -1) {
            ...
            String txtVenda = "Venda: { computador" + obj.getComputador().getNumeroMaquina() + ", cliente: " + obj.getCliente().getNome() + ", funconario: " + obj.getFuncionario().getNome() + "}";
